---
name: docpurify
description: Convert PDF, Office documents, and images into clean Markdown with DocPurify MCP. Use when the user wants to process uploaded documents, extract structured text, poll document jobs, fetch Markdown results, or manage DocPurify document-processing tasks.
---
